            ...
            showErrors: function(errorMap, errorList){
                ...
                if(!!errorList.length){
                    ...
                    for(var i = 0, len = errorList.length; i < len; i++){
                        ...
                        if( $element.parent('.form-group i.pticon-error') &&  $element.parent('.form-group').find('i.pticon-error').length > 0){
                             $element.parent('.form-group i.pticon-error').removeClass("validate-hidden");
                        }else{
                             $element.parent('.form-group').append("<i class='pticon pticon-error'></i>");                        }
                        }
                    ...
                    for(var i = 0; i < len; i++){
                        ...
                        $element = $(element);
                        $element.parent('.form-group').find('i.pticon-error').addClass('validate-hidden');
